...
| `DEC-MONO-002` | web/admin 운영 hostname 및 기존 링크 전환 | **확정(2026-09-06)**: admin `truewords-admin.woosung.dev`, web 은 컷오버 후 `truewords.woosung.dev` 로 canonical 전환(`app.woosung.dev` 폐지). zone 공유라 프로젝트 접두어 통일 |
