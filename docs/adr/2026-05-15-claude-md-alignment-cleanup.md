...
- **`chat/dependencies.py` lazy-init double-check lock**: `docs/adr/46-qdrant-cache-cold-start-debug.md` 에 명시된 의도된 fix. Lifespan event 로 교체 시 PR #73 (Cloudflare Tunnel) 회귀 위험.
