...
`docs/architecture/target-architecture-blueprint-2026-05-01.html` (외부 자료의 repo 사본, 시점 고정 참고용) 가 진단한 항목 중 **여러 곳이 실제 코드와 불일치**. 본 ADR 은 사실/허구를 분리 기록한다.
...
| "9봇 자동 선택" 가정 | 운영 활성 봇 수는 메모리상 PoC 봇 4개 비활성 처리 (PR #87) | `docs/adr/52-collection-main-deprecation.md` | ⚠️ 청사진 가정과 운영 현황 다름 |
...
- 청사진 repo 사본: `docs/architecture/target-architecture-blueprint-2026-05-01.html`
- 설정 전파 경로 ADR: `docs/adr/2026-05-01-cascade-threshold-paths.md`
