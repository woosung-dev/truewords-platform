...
| `docs/runbooks/environment-setup.md` | 표 업데이트 |
| `docs/runbooks/ci-cd-pipeline.md:51` | 동일 |
...
| `docs/runbooks/environment-setup.md` | 표 갱신 |
| `docs/runbooks/ci-cd-pipeline.md` | 환경변수 표기 갱신 |
