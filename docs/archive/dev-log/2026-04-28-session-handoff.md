...
### dev-log
- `docs/archive/plans/2026-04-28-phase-2-plan.md`
- `docs/research/2026-04-28-phase-1-eval-report.md` (옵션 D)
- `docs/research/2026-04-28-source-ablation.md` (옵션 G)
- `docs/research/2026-04-28-prefix-dryrun.md` (옵션 B 평화경 dry-run)
