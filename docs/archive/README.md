...
| `design-2026-09-pc-chat/` | 채택되지 않은 PC 데스크톱 시안 4안의 구조 요약. HTML 9종(약 467KB)은 [ADR-VIEW](../adr/2026-09-14-mobile-pc-view-strategy.md) `DEC-VIEW-002` 로 폐기했고 컬럼 폭·레버 채택표·실측 통계만 남겼다 |
