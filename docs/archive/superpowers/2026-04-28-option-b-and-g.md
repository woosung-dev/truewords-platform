...
본 세션 옵션 D 결과 (`docs/research/2026-04-28-phase-1-eval-report.md`):
...
| 생성 | `docs/research/2026-04-28-source-ablation.md` | G 결과 + 약점 source 식별 |
| **B 인프라 그룹** | | |
...
- Create: `docs/research/2026-04-28-source-ablation.md`
...
- [ ] **Step 4: 보고서 작성** (`docs/research/2026-04-28-source-ablation.md`)
...
```bash
git add docs/research/2026-04-28-source-ablation.md
...
- Create: `docs/research/2026-04-28-prefix-dryrun.md`
...
- [ ] **Step 4: 보고서 작성** (`docs/research/2026-04-28-prefix-dryrun.md`) — sample 5개 인용 + 품질 평가 + 본 생성(Task 12) GO/NO-GO 결정.

- [ ] **Step 5: commit**

```bash
git add docs/research/2026-04-28-prefix-dryrun.md
...
- [ ] **Step 2: G의 약점 source부터 우선** — G 보고서(`docs/research/2026-04-28-source-ablation.md`)의 우선순위 #1 source를 갖는 권을 먼저 처리:
...
- [ ] `docs/research/2026-04-28-source-ablation.md` (G)
- [ ] `docs/research/2026-04-28-prefix-dryrun.md` (B Task 11)
