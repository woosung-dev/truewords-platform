...
> **상세 계획:** `docs/archive/plans/2026-03-28-phase3-data-pipeline.md` (기존 Phase 3 문서)
...
> **기반 계획:** `docs/archive/plans/2026-03-28-phase4-production-infra.md` (기존 Phase 4 문서)
...
> **설계 참조:** `docs/architecture/09-security-countermeasures.md`
...
> **기반 계획:** `docs/archive/plans/2026-03-28-phase2-web-chat-ui.md` (기존 Phase 2 문서)
