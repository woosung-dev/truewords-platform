...
| `docs/adr/30-upload-on-duplicate-mode.md` | "후속 작업" 항목 완료 표시 | Modify |
...
**Files:**
- Modify: `docs/TODO.md`
- Modify: `docs/adr/30-upload-on-duplicate-mode.md`
...
`docs/adr/30-upload-on-duplicate-mode.md` "후속 작업" 항목을 "[완료]"로 표시 + 커밋 해시 인용.
...
```bash
git add docs/TODO.md docs/adr/30-upload-on-duplicate-mode.md
