...
- `docs/dev-log/2026-05-01-reranker-cross-encoder-ab-decision.md` (본 ADR)
- `docs/dev-log/2026-05-01-reranker-ab-results.json` (R1 raw)
- `docs/dev-log/2026-05-01-reranker-ab-results.md` (R1 분석)
- `docs/dev-log/2026-05-01-reranker-ab-results-round2.json` (R2 raw)
- `docs/dev-log/2026-05-01-reranker-ab-results-round2.md` (R2 분석 + R1/R2 비교)
