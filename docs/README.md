...
| [훈독 DESIGN.md 7안 비교](prd/2026-09-16-hoondok-designmd-directions.md), 보드 [board-designmd.html](prd/prototypes/hoondok-ds/board-designmd.html) | `DES-PWA-005`. A 기준 + 브랜드 DESIGN.md 6종(Apple·Notion·WIRED·Starbucks·Claude·Airbnb)을 훈독으로 번역. 마크업 한 벌 + 테마 CSS 7장, 폰 390·PC 1280 캡처 35장, 독립 심사 3명(**C·E 84.3 동률** · F 78.7 · A 73.3). **어떤 안으로 갈지 결정 대기** |
