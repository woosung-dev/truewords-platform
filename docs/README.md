...
| [훈독 데스크톱 시안 4안 비교](prd/2026-09-16-hoondok-desktop-directions.md) | `DES-PWA-004`. 같은 제품을 네 가지 시각 언어로 그린 1280px 클릭형 시안 4벌 + 캡처 40장 + 독립 블라인드 심사 3명(D 89.3 · C 80.0 · A 74.3 · B 73.3). **2026-09-16 결정: A 기준 + 헤더 4 + AI 질문 "물음 한 장"**, 16화면 단일 소스 프로토타입 완성 |
| [훈독 DESIGN.md 7안 비교 + 16화면 프로토타입](prd/2026-09-16-hoondok-designmd-directions.md), 보드 [board-pc.html](prd/prototypes/hoondok-ds/board-pc.html)(16화면 폰+PC) · [board-designmd.html](prd/prototypes/hoondok-ds/board-designmd.html) · [board-nav.html](prd/prototypes/hoondok-ds/board-nav.html) | `DES-PWA-005`. A 기준 + 브랜드 DESIGN.md 6종(Apple·Notion·WIRED·Starbucks·Claude·Airbnb)을 훈독으로 번역. 마크업 한 벌 + 테마 CSS 7장, 폰 390·PC 1280 캡처 35장, 독립 심사 3명(**C·E 84.3 동률** · F 78.7 · A 73.3). **2026-09-16 결정: A 기준 + 헤더 4 + AI 질문 "물음 한 장"**, 16화면 단일 소스 프로토타입 완성 |
