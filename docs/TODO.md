...
- [x] 세션 1 v1 — PRD 초안 (PR #261, 2026-09-07). 2026-09-09 사용자가 디자인 완성도 부족으로 close, 브랜치 보존
- [x] 세션 1·2 v2 — **PR #262** (2026-09-09, main 머지 대기) 초원식 5탭 + 루틴·챌린지 허용(`DEC-PWA-014`)으로 PRD 재작성(`docs/prd/17-ffwpu-pwa-prd.md`) + 디자인 2안(A 새벽 / B 등불) 프로토타입·스크린샷·3렌즈 리뷰(`docs/prd/2026-09-09-hundok-design-directions.md`)
- [ ] `[확인 필요]` `DEC-PWA-015` 디자인 방향 선택 (A / B / A 골격 + B 가정예배 화면, 추천 ★5 결합안)
- [ ] `[확인 필요]` `DEC-PWA-016` 제품명 "훈독" 확정, 4번째 탭 이름(가정예배 / 훈독회 / 가정), 가정예배 순서 발행 주체, 설교 영상 호스팅
- [ ] 세션 2 후속 — S3 진입 전 원문 액션바 겹침·B 하이라이트 대비·질문 FAB 가림 3건 정리 (DES-PWA-002 §4.3)
