...
### 훈독(가안) 앱 PRD v2 + 디자인 2안 클릭형 프로토타입 (2026-09-10)
...
- `[확인 필요]` `DEC-PWA-017` 디자인 방향 — A 아침 햇살 / B 저녁 등불 / A 골격 + B 흡수(추천 ★4). [DES-PWA-002 §4](prd/2026-09-10-hundok-design-directions.md#4-추천-제안)
- `[확인 필요]` `DEC-PWA-015` 5탭 명칭 — 오늘 훈독 · AI 질문 · 말씀 · 가정예배 · 나의 뜰(대안: 나의 정원 / 나의 훈독 / 내 정성)
- `[확인 필요]` `DEC-PWA-016` 앱 이름 가안 "훈독" 확정 여부와 공식 승인 전 사용 가능한 명칭 범위
- `[확인 필요]` `DEC-PWA-019` 개인 랭킹·달란트형 화폐 도입 여부 (PRD v2 기본 제외)
...
- [ ] 세션 3 — 채택안 디자인 시스템·접근성 상태 작성·승인. 목표 2026-09-21
- [ ] 세션 4 — 구현 설계(미션·정성·챌린지·관계·설교 도메인 포함)·작업 분해·제한 베타 계획과 S5~S15 실행 runbook 작성. 목표 2026-09-28
