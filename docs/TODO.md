...
- `[확인 필요]` **데스크톱 내비 A 좌측 레일 vs B 상단 헤더** — 사용자가 A 기준 테마를 택한 뒤 내비만 2안으로 비교(`board-nav.html`, `?nav=rail|top`). `DES-PWA-003` §4.1 은 레일, `DES-PWA-004` 도구 3종은 상단. [DES-PWA-005 §5.5](prd/2026-09-16-hoondok-designmd-directions.md)
