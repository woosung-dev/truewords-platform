...
- [x] 세션 1·2 v2 — 2026-09-09 초원식 5탭 + 루틴·챌린지 허용(`DEC-PWA-014`)으로 PRD 재작성(`docs/prd/17-ffwpu-pwa-prd.md`) + 디자인 2안(A 새벽 / B 등불) 프로토타입·스크린샷·3렌즈 리뷰(`docs/prd/2026-09-09-hundok-design-directions.md`)
