...
- [ ] **2단계 구현 착수** — #317·#318 main 머지 뒤 `dev/hoondok-groups` 를 main 에서 자르고 트랙 A → W0 → W1∥W2∥C → 통합 ([PLAN-HD-010 §8](plans/active/2026-09-23-hoondok-groups.md#8-트랙-분해-오케스트레이터-모드-devhoondok-groups))
