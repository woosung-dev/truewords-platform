...
open http://localhost:8765/            # index.html: 21화면을 폰·PC 나란히
open http://localhost:8765/app.html?screen=ask
```

| 쿼리 | 값 |
|---|---|
| `screen` | today · read · words · library · search · onboarding · ask · ask-log · ask-detail · worship · challenge · sermons · sermon-request · garden · settings · family · group · group-join · group-create · group-share · group-settings |
...
| `role` | member 이면 모임 설정(`group-settings`)의 모임원 보기(내 이름 변경·나가기만). 기본은 리더 보기 |
