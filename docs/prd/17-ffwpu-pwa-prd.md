...
- 상태: **S2' 방향 확정** (2026-09-14 사용자 결정 `DEC-PWA-015·016·017·019`). S3 디자인 시스템 진입 가능
...
| `DEC-PWA-017` | 2026-09-14 | **확정** | 디자인 방향 **A 아침 햇살 단독**(라이트 `#fbfaf8`·감귤 `#c24721`·Pretendard 단일·16px·사진 히어로). B 저녁 등불 미채택.의 A+B 흡수 추천 3항목(시간대별 홈 전환·세리프 말씀 인용·B 팔레트 다크 모드)은 모두 도입하지 않는다. **베타는 라이트 고정**이며 다크 모드는 출시 후 수요를 보고 재검토한다 |
