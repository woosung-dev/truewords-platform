...
- 함께 볼 것: [프로토타입 `hoondok-ds`](prototypes/hoondok-ds/README.md) (16화면, 폰·PC 단일 소스), [디자인 시스템 `DES-PWA-003`](../specs/web/hoondok-design-system.md)
...
- `AC-020-02`: 진행률·참여 인원은 표시하되 개인 순위·랭킹은 두지 않는다 (`DEC-PWA-019` 2026-09-14 확정).
