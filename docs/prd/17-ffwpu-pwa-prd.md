...
| `SCR-PWA-005` | AI 질문 (묻기 홈) + 질문 기록 | AI 질문 | `JTBD-003`. **2026-09-16 변경**: 탭 홈은 묻기 한 가지(오늘 말씀 한 줄 + 라벨 있는 입력 + 시작 문장 3개가 입력창을 채움). 추천/북마크/내 질문은 앱바 "기록" 화면으로 분리. FAB 없음. [DES-PWA-005 §5.6](2026-09-16-hoondok-designmd-directions.md) | 묻기·추천은 비로그인, 기록은 로그인 |
...
| `DEC-PWA-017` | 2026-09-14 | **확정** | 디자인 방향 **A 아침 햇살 단독**(라이트 `#fbfaf8`·감귤 `#c24721`·Pretendard 단일·16px·사진 히어로). B 저녁 등불 미채택. [디자인 문서 §4](2026-09-10-hundok-design-directions.md#4-추천-제안)의 A+B 흡수 추천 3항목(시간대별 홈 전환·세리프 말씀 인용·B 팔레트 다크 모드)은 모두 도입하지 않는다. **베타는 라이트 고정**이며 다크 모드는 출시 후 수요를 보고 재검토한다 |
