...
class VolumeTagsBulkResponse(BaseModel):
    ...
    skipped_volumes: list[SkippedVolume] = Field(
...
class VolumeDeleteResponse(BaseModel):
    ...
    skipped: list[SkippedVolume] = Field(
        default_factory=list,
...
class UploadResponse(BaseModel):
    ...
    mode: str = Field(..., description="호환용 입력값 반환. 처리 방식은 항상 standard")
