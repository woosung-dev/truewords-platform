...
generate_answer 는 app.modules.chat.generator 의 alias 로 모듈 attribute 로 보존한다 (
다수의 테스트가 'app.modules.chat.pipeline.stages.generation.generate_answer' 경로로
patch 하기 때문).
...
from app.modules.chat.generator import generate_answer
from app.modules.chat.history import select_history_window
...
from app.modules.chat.prompt import compose_system_prompt
from app.modules.chatbot.runtime_config import GenerationConfig
from app.modules.search.intent_classifier import Intent, generation_context_slice_for
