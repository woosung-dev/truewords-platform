...
from app.core.common.event_loop import get_main_loop  # audit 2차 B-3 — worker 역의존 제거
from app.core.config import settings
from app.modules.datasource.dependencies import get_qdrant_service
from app.modules.pipeline.chunker import chunk_recursive
from app.modules.pipeline.extractor import extract_text
...
from app.modules.pipeline.metadata import classify_book_series, extract_metadata
...
def process_file_standard(
    ...
    try:
        ...
        if strategy["needs_reset"]:
            from app.modules.pipeline.ingestor import _sync_delete_by_filter
