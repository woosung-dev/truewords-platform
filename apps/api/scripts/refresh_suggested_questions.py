...
cleanup_semantic_cache.py 와 동일한 인프라 무관 패턴:
  EC2 cron      30 3 * * * cd /path/apps/api && uv run python scripts/refresh_suggested_questions.py --execute
...
from app.modules.chatbot.repository import ChatbotRepository  # noqa: E402
from app.modules.chatbot.suggested_service import SuggestedQuestionsService  # noqa: E402
