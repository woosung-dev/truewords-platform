...
class TestEmbeddingReuse:
    ...
    @pytest.mark.asyncio
    @patch("app.modules.search.cascading.embed_sparse_async", new_callable=AsyncMock)
    @patch("app.modules.search.cascading.embed_dense_query", new_callable=AsyncMock)
    @patch("app.modules.search.hybrid.embed_sparse_async", new_callable=AsyncMock)
    @patch("app.modules.search.hybrid.embed_dense_query", new_callable=AsyncMock)
