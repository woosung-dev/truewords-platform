...
from app.modules.search.collection_resolver import ResolvedCollections, resolve_collections


class TestResolveCollections:
    def test_uses_settings_default(self) -> None:
        with patch("app.modules.search.collection_resolver.settings") as mock_settings:
