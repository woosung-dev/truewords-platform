...
from app.modules.admin.data_router import _compute_content_hash, _predict_outcome
...
def test_process_file_standard_wires_strategy_correctly():
    ...
    from app.modules.admin.data_router import _process_file_standard
...
from app.modules.admin.data_router import _resolve_upload_strategy
