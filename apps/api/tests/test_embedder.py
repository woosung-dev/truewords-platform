...
from app.modules.pipeline.embedder import embed_dense_document, embed_dense_query, embed_sparse
...
def test_embed_dense_document_returns_3072_floats():
    ...
    with patch("app.modules.pipeline.embedder._client") as mock_client:
...
def test_embed_sparse_returns_indices_and_values():
    ...
    with patch("app.modules.pipeline.embedder.get_sparse_model") as mock_get:
