...
- `docs/architecture/diagrams/`의 JSON/HTML/PNG는 2026-09-06 현재 구조(main `8980e0c`)로 재생성했다. 코드 경로·수치는 해당 commit 기준이며 운영 배포 증거는 runbook 을 따른다. 분리 전 JSON 은 `docs/archive/diagrams-2026-09-04/`.
